...
function Sidebar() {
  return (
    <div className='flex flex-col border-r border-text1 min-h-full pt-6'>
      ...
      <NavLink end={true} to='/admin/manage-events' className={({isActive})=> `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-64 cursor-pointer ${isActive && "bg-text1/10 border-r-4 border-text1"}`}>
        <img src={assets.list_icon} alt='' className='min-w-4 w-5' />

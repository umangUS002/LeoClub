...
const Blogs = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="rounded-lg h-65 shadow-lg hover:shadow-xl transition-all duration-200 w-44 sm:w-52 flex-shrink-0">
            <div className="h-50">
                <img className="w-full h-50 px-2 py-2 rounded-lg" src={card.image} alt="User Image" />
            </div>
            <p className="text-sm px-2 mb-2 text-sky-500">International Yoga Day</p>
    ...
    return (
        <div className="md:px-25">
            <div className="py-10 flex mt-40 max-sm:flex-col bg-gradient-to-r from-text1/30 to-transparent">
                <style>{`
                ...
                <div className="w-full md:w-1/2">
                    <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative px-4">
                        <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none" />
                        <div className="marquee-inner flex gap-x-4 transform-gpu min-w-[200%] pt-5 pb-5">
                    ...
                    <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative px-4">
                        <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none" />
                        <div className="marquee-inner marquee-reverse flex gap-x-4 transform-gpu min-w-[200%] pt-0 pb-5">
                            {[...cardsData, ...cardsData].map((card, index) => (
                                <CreateCard key={index} card={card} />
                            ))}
                        </div>
